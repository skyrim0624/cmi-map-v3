...
const mapFilters: FilterItem[] = [
  ...
  { id: 'events', label: '活动', iconUrl: '/map-icons/cmi-theme/wild-lantern.png' },
  ...
  return (
    <section className="cmi-v3-map-mode" aria-label="CMI Map 3.0 地图形态页">
      ...
      {primaryActivityEvent && (
        ...
        >
          <img className="cmi-v3-map-activity-entry-icon" src="/map-icons/cmi-theme/wild-lantern.png" alt="" />
          <span>活动</span>
        </button>
      )}
