...
export const CMI_EVENTS: CmiEvent[] = [
  ...
  {
    id: 'cmi-blood-on-the-clocktower-newbie-game-2026-06-04',
    title: '血染钟楼新手局：死亡不退场的社交推理',
    type: 'meetup',
    startAt: '2026-06-04T15:00:00+07:00',
    endAt: '2026-06-04T18:00:00+07:00',
    venueName: '清迈客栈',
    area: 'CMI / 清迈客栈',
    mapLocation: { latitude: 18.7932, longitude: 98.9874, category: '清迈客栈' },
    priceLabel: '免费参与',
    ...
    hostName: 'CMI 社区',
    language: '中文',
    suitableFor: ['桌游新手', '狼人杀/剧本杀玩家', '推理游戏爱好者', '想轻松认识新朋友'],
    isCmiRelated: true,
    isVerified: true,
    verificationStatus: 'verified',
    lastCheckedAt: '2026-06-02T08:25:58+07:00',
    nextCheckBefore: '2026-06-04T13:00:00+07:00',
    reliabilityNote:
      '信息来自 6.4 血染钟楼新手局推文、同目录发布页与官方海报；时间、地点、费用和原始空降参与方式均明确。远程活动已在上一轮通过 CMI Map CLI 管理员通道发布，本轮补齐本地兜底与图片映射。',
    tags: ['CMI', '清迈客栈', '血染钟楼', '桌游', '社交推理', '新手友好', '免费'],
    summary: '如果你玩过狼人杀、剧本杀，或者只是喜欢观察人和判断信息，《血染钟楼》会是一场适合你的社区桌游局。',
    organizerName: 'CMI 社区',
    organizerEmail: 'events@cmimap.com',
    registrationEnabled: true,
    registrationStatus: 'open',
    attendeeVisibility: 'count-only',
    coverImageUrl: '/cmi-home/event-posters/cmi-blood-on-the-clocktower-newbie-game-2026-06-04.png',
  },
  {
    id: 'cmi-mindfulness-hour-singing-bowl-2026-06-04',
    title: '正念一小时｜颂钵公益：让心慢慢来',
    type: 'meditation',
    startAt: '2026-06-04T19:00:00+07:00',
    endAt: '2026-06-04T20:30:00+07:00',
    venueName: '清迈客栈',
    area: 'CMI / 清迈客栈',
    mapLocation: { latitude: 18.7932, longitude: 98.9874, category: '清迈客栈' },
    priceLabel: '免费参与',
    ...
    hostName: 'CMI 社区',
    language: '中文',
    suitableFor: ['正念练习', '颂钵体验', '想慢下来', '社区分享'],
    isCmiRelated: true,
    isVerified: true,
    verificationStatus: 'verified',
    lastCheckedAt: '2026-06-02T16:39:04+07:00',
    nextCheckBefore: '2026-06-04T17:00:00+07:00',
    reliabilityNote:
      '信息来自 6.4 正念一小时推文、同目录发布页与官方海报；时间、地点、公益费用和活动内容明确。原始材料未单列报名链接或二维码，本轮按 CMI Map 内置报名系统发布。',
    tags: ['CMI', '清迈客栈', '正念', '颂钵', '冥想', '公益', '免费'],
    summary: '一场在清迈客栈举办的公益正念活动，通过静坐冥想、智慧引领、开放分享和颂钵体验，让心慢慢回到当下。',
    organizerName: 'CMI 社区',
    organizerEmail: 'events@cmimap.com',
    registrationEnabled: true,
    registrationStatus: 'open',
    attendeeVisibility: 'count-only',
    coverImageUrl: '/cmi-home/event-posters/cmi-mindfulness-hour-singing-bowl-2026-06-04.jpg',
  },
  {
    id: 'cmi-ai-open-mic-vol-05-2026-06-05',
    title: 'AI 开放麦05｜大家一起聊聊天！',
    type: 'tech',
    startAt: '2026-06-05T19:00:00+07:00',
    venueName: '清迈客栈',
    area: 'CMI / 清迈客栈',
    mapLocation: { latitude: 18.7932, longitude: 98.9874, category: '清迈客栈' },
    priceLabel: '免费参与',
    ...
    hostName: 'CMI 社区',
    language: '中文',
    suitableFor: ['AI 工具使用者', 'AI 创业者', '正在做项目的人', '想交流本周 AI 观察的人'],
    isCmiRelated: true,
    isVerified: true,
    verificationStatus: 'verified',
    lastCheckedAt: '2026-06-02T12:56:43+07:00',
    nextCheckBefore: '2026-06-05T17:00:00+07:00',
    reliabilityNote:
      '信息来自 6.5 AI 开放麦第五期推文、同目录发布页与官方海报；时间、地点、费用和参与方式均明确。本轮通过 CMI Map CLI 管理员通道发布。',
    tags: ['CMI', '清迈客栈', 'AI', '开放麦', '科技', '免费'],
    summary: 'AI 工具每天都在变化，真正有价值的经验，往往来自具体使用现场。',
    organizerName: 'CMI 社区',
    organizerEmail: 'events@cmimap.com',
    registrationEnabled: true,
    registrationStatus: 'open',
    attendeeVisibility: 'count-only',
    coverImageUrl: '/cmi-home/event-posters/cmi-ai-open-mic-vol-05-2026-06-05.png',
  },
  {
    id: 'cmi-kongxiang-canteen-hotpot-2026-06-05',
    title: '空想食堂火锅局｜6 月第一周清迈客栈晚餐',
    type: 'cmi',
    startAt: '2026-06-05T19:00:00+07:00',
    venueName: '清迈客栈',
    area: 'CMI / 清迈客栈',
    mapLocation: { latitude: 18.7932, longitude: 98.9874, category: '清迈客栈' },
    priceLabel: '免费参与；请每个人带一道适合火锅的食材来和大家分享',
    registrationLabel: CMI_MAP_EVENT_REGISTRATION_LABEL,
    sourceType: 'cmi',
    sourceLabel: 'CMI 活动宣传内容文件夹',
    hostName: 'CMI 社区',
    language: '中文',
    suitableFor: ['社区晚餐', '火锅', '轻社交', '周五晚上'],
    isCmiRelated: true,
    isVerified: true,
    verificationStatus: 'verified',
    lastCheckedAt: '2026-06-02T12:56:43+07:00',
    nextCheckBefore: '2026-06-05T17:00:00+07:00',
    reliabilityNote:
      '信息来自 6.5 空想食堂推文、同目录发布页与官方海报；时间、地点、费用和参与方式均明确。本轮通过 CMI Map CLI 管理员通道发布。',
    tags: ['CMI', '清迈客栈', '空想食堂', '火锅', '社区活动', '免费'],
    summary: '6 月第一周的空想食堂开火锅局，每个人带一道适合火锅的食材来，大家一起煮、一起吃、一起聊。',
    organizerName: 'CMI 社区',
    organizerEmail: 'events@cmimap.com',
    registrationEnabled: true,
    registrationStatus: 'open',
  ...
  },
  {
    ...
    title: '《我的章鱼老师》观影：你有多久，没有真正观察过另一个生命？',
    type: 'cmi',
    startAt: '2026-06-06T19:00:00+07:00',
    venueName: 'CMI',
    area: 'CMI / 清迈客栈',
    mapLocation: { latitude: 18.7932, longitude: 98.9874, category: '清迈客栈' },
    priceLabel: '免费参与',
    ...
    language: '中文',
    suitableFor: ['纪录片观影', '自然与海洋', '周六晚上', '想安静看电影的人'],
    isCmiRelated: true,
    isVerified: true,
    verificationStatus: 'verified',
    lastCheckedAt: '2026-06-02T12:56:43+07:00',
    nextCheckBefore: '2026-06-06T17:00:00+07:00',
    reliabilityNote:
      '信息来自 6.6 Magic Lab 放映会推文、同目录发布页与官方海报；时间、地点、费用和参与方式均明确。本轮通过 CMI Map CLI 管理员通道发布。',
    tags: ['CMI', 'Magic Lab', '观影会', '纪录片', '自然', '免费'],
    summary: '这周六晚，Magic Lab 将在 CMI 放映《我的章鱼老师》，一部关于观察、陪伴和自然智慧的纪录片。',
    organizerName: 'Magic Lab × CMI',
    organizerEmail: 'events@cmimap.com',
    registrationEnabled: true,
    registrationStatus: 'open',
    attendeeVisibility: 'count-only',
  ...
  {
    id: 'cmi-machine-learning-intro-2026-06-17',
    ...
    language: '中文',
    suitableFor: ['AI 工具使用者', '机器学习初学者', 'Codex / Agent 学习者', '想线下学习讨论的人'],
    isCmiRelated: true,
    isVerified: true,
    verificationStatus: 'verified',
  ...
  {
    id: 'cmi-wild-chiang-mai-nature-quest-2026-06-18',
    ...
    hostName: 'CMI 社区',
    language: '中文',
    suitableFor: ['清迈自然观察', '散步拍照', '动植物爱好者', '想用 CMI Map 参与主题任务的人'],
    isCmiRelated: true,
    isVerified: true,
    verificationStatus: 'verified',
    lastCheckedAt: '2026-06-17T14:48:58+07:00',
    nextCheckBefore: '2026-06-18T14:30:00+07:00',
    reliabilityNote:
      '信息来自 6月18日 清迈神奇动物在哪里 wechat-manual.md、图片序列和小红书最终封面；线下集合时间、目的地、线上参与方式、费用说明和 CMI 归属均明确。',
    tags: ['CMI', '清迈客栈', 'CMI Map', '自然探索', '动植物', '主题活动'],
    ...
    registrationStatus: 'open',
    attendeeVisibility: 'count-only',
    coverImageUrl: '/cmi-home/event-posters/cmi-wild-chiang-mai-nature-quest-2026-06-18.jpg',
  },
  {
    id: 'cmi-kongxiang-canteen-zongzi-2026-06-19',
    ...
    hostName: 'CMI 社区',
    language: '中文',
    suitableFor: ['端午节', '社区晚餐', '手作包粽子', '周五下午轻社交'],
    isCmiRelated: true,
    isVerified: true,
    verificationStatus: 'verified',
    lastCheckedAt: '2026-06-17T14:48:58+07:00',
    nextCheckBefore: '2026-06-19T14:00:00+07:00',
    reliabilityNote:
      '信息来自 6月19日 空想食堂端午包粽子推文、发布页与官方海报；时间、地点、费用和参与方式均明确。',
    tags: ['CMI', '清迈客栈', '空想食堂', '端午', '包粽子', '免费'],
    ...
    registrationStatus: 'open',
    attendeeVisibility: 'count-only',
    coverImageUrl: '/cmi-home/event-posters/cmi-kongxiang-canteen-zongzi-2026-06-19.png',
  },
  {
    id: 'cmi-ai-open-mic-community-ai-2026-06-19',
    ...
    hostName: 'CMI 社区',
    language: '中文',
    suitableFor: ['AI 工具使用者', '社区建设者', '正在做项目的人', '想听开放讨论的人'],
    isCmiRelated: true,
    isVerified: true,
    verificationStatus: 'verified',
    lastCheckedAt: '2026-06-17T14:48:58+07:00',
    nextCheckBefore: '2026-06-19T18:00:00+07:00',
    reliabilityNote:
      '信息来自 6.19 AI开放麦第七期推文、发布页与官方海报；时间、地点、费用和参与方式均明确。',
    tags: ['CMI', '清迈客栈', 'AI', '开放麦', '社区', '免费'],
    ...
    registrationStatus: 'open',
    attendeeVisibility: 'count-only',
    coverImageUrl: '/cmi-home/event-posters/cmi-ai-open-mic-community-ai-2026-06-19.png',
  },
  {
    id: 'cmi-swap-skills-market-2026-06-20',
    title: '旧物与技能交换集市',
    type: 'market',
    ...
    hostName: 'CMI 社区',
    language: '中文',
    suitableFor: ['旧物交换', '技能交换', '新来清迈', '周六下午轻社交'],
    isCmiRelated: true,
    isVerified: true,
    verificationStatus: 'verified',
    lastCheckedAt: '2026-06-17T14:48:58+07:00',
    nextCheckBefore: '2026-06-20T13:00:00+07:00',
    reliabilityNote:
      '信息来自 6.20 旧物技能交换集市推文、发布页与官方海报；时间、地点、费用和参与方式均明确。原始海报 17MB，本轮压缩为 1280 宽 JPEG 后上传。',
    tags: ['CMI', '清迈客栈', '旧物交换', '技能交换', '市集', '免费'],
    ...
    registrationStatus: 'open',
    attendeeVisibility: 'count-only',
    coverImageUrl: '/cmi-home/event-posters/cmi-swap-skills-market-2026-06-20.jpg',
  },
  {
    id: 'cmi-fantastic-fungi-screening-2026-06-20',
    ...
    hostName: 'Magic Lab × CMI',
    language: '中文',
    suitableFor: ['纪录片观影', '自然生态', '意识与连接主题', '周六晚上'],
    isCmiRelated: true,
    isVerified: true,
    verificationStatus: 'verified',
    lastCheckedAt: '2026-06-17T14:48:58+07:00',
    nextCheckBefore: '2026-06-20T17:00:00+07:00',
    reliabilityNote:
      '信息来自 6.20 Magic Lab 观影会推文、发布页与官方海报；时间、地点、费用和参与方式均明确。',
    tags: ['CMI', '清迈客栈', 'Magic Lab', '观影会', '纪录片', '免费'],
