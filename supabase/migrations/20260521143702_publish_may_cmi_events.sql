...
values
  (
    ...
    'verified',
    'published',
    '2026-05-21T14:37:34+07:00',
    '2026-05-21T17:00:00+07:00',
    '信息来自五月活动文件夹中的推文 Markdown 与海报交叉核对，时间、地点、形式和参与方式均明确。',
  ...
  (
    ...
    '日期来自五月活动文件夹中的“5.22 瑜伽舒缓课”目录，时间、地点、费用和导师信息来自同目录推文 Markdown；原文未提供单独报名链接或二维码说明。',
  ...
  (
    ...
    '2026-05-21T14:37:34+07:00',
    '2026-05-22T17:00:00+07:00',
    '时间信息来自五月活动文件夹推文中“5 月 22 日（周五）晚 🕖”的明确表述，其余地点、费用和参与方式来自同目录活动文案与海报。',
